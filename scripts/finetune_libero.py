...
default_config_file = os.path.join(
    os.path.dirname(__file__), "configs/finetune_libero_config.py"
)
...
def main(_):
    ...
    logging.info(
        ...
        Finetuning mix: {FLAGS.config.dataset_kwargs.oxe_kwargs.data_mix}
        ...
        Batch size: {FLAGS.config.dataset_kwargs.batch_size} ({FLAGS.config.dataset_kwargs.batch_size // len(devices) } per device)
    ...
    # val_datasets_kwargs_list = [FLAGS.config.dataset_kwargs]
